...
if __name__ == '__main__':
    ...
    fs.add_argument("--o_name", dest = "o_name", action = "store", type = str, default='Rain_Attenuation_vs_Elevation' , help = "Output File Base Name")
    ...
    title_str = 'Worst Case ({:1.1f}%) Rain Attenuation vs Elevation'.format(p)
